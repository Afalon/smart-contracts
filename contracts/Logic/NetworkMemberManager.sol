...
contract NetworkMemberManager {
    ...
    modifier onlyIRN() {
        require(atonomiStorage.getBool(keccak256("network", "msg.sender", "isIRNAdmin")), "must be owner or an irn admin");
        _;
    }
        ...
        public onlyIRN returns(bool)
    {
        ...
        if (_isManufacturer) {
            ...
            if (atonomiStorage.getAddress(keccak256("pools", _member, "rewardAmount")) == 0) {
                ...
                atonomiStorage.setUint(keccak256("pools", _member, "rewardAmount"), atonomiStorage.getUint(keccak256("defaultReputationReward")));
            }
        }
